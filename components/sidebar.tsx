const Sidebar = () => {
    return (
        <div className="w-[328px] h-[640px] relative bg-gradient-to-b from-zinc-900 to-neutral-800 rounded-3xl shadow border border-white border-opacity-5 backdrop-blur-[120px]">
            ...
            <div className="left-[8px] top-[64px] absolute flex-col justify-start items-start gap-2 inline-flex overflow-y-auto h-[500px] hide-scrollbar"> {/* Adjust height as needed */}
                <div className="w-[312px] h-16 relative mb-1"> {/* This is the container div */}
                    <div className="w-[312px] h-16 relative">
                        ...
                        <img className="w-14 h-14 left-[4px] top-[4px] absolute rounded-xl border backdrop-blur-[120px]" src="https://via.placeholder.com/56x56" />
